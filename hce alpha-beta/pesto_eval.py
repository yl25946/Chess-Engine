...
def init_tables():
    ...
    while(piece < chess.KING):
        for square in range (64):
            mg_table[piece_color][square] = mg_value[piece] + mg_pesto_table[piece][square]
            eg_table[piece_color][square] = eg_value[piece] + eg_pesto_table[piece][square]
            mg_table[piece_color + 1][square] = mg_value[piece] + mg_pesto_table[piece][flip(square)]
            eg_table[piece_color + 1][square] = eg_value[piece] + eg_pesto_table[piece][flip(square)]
